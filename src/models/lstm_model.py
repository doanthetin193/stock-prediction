"""
LSTM Model cho dự đoán giá cổ phiếu.
Kiến trúc: 2 lớp LSTM + Dropout + Dense
"""
import numpy as np
import os

os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2'  # Tắt warning TensorFlow
...
class LSTMModel:
    ...
    def _build_model(self) -> Sequential:
        ...
        model = Sequential([
            ...
            Dense(1)  # Output: 1 giá trị (close price)
        ])
    ...
    def train(self, X_train: np.ndarray, y_train: np.ndarray,
        ...
        Args:
            X_train: shape (samples, seq_length, features)
    ...
    def save(self, symbol: str):
        """Lưu model."""
        path = os.path.join(MODELS_DIR, f"lstm_{symbol}.keras")
